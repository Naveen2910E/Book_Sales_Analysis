...
Handled missing values in Book Name and language_code (Page 3–4)

Ensured there were no duplicate entries (0 duplicates).
...
Genre fiction dominates with ~750 books.
...
Most genres have consistent ratings between 3.8 and 4.2.
...
Higher price does not always reduce sales drastically.
...
“eng” (English) dominates with 670 books.

Followed by “en-US” (226) and “en-GB”.
...
Penguin Group (USA) LLC is the highest earner.
...
Intermediate authors receive the highest user engagement.
...
Books rated 3.8–4.5 mostly attract the highest number of readers.
...
Harper Lee has the highest total gross sales.
...
Most books were published between 1985–2015.

Fiction dominates the dataset.

English is the primary language used.

Higher-rated books generally attract more readers.

A few top authors and publishers generate most of the revenue.

Total book sales have increased strongly over the last 50 years.

This project demonstrates skills in data cleaning, visualization, pattern recognition, and generating business insights that can help publishers or retailers understand market trends.
